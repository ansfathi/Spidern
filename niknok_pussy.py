...
class qredes:
  ...
  def search1(self,keyword):
        ...
        url='https://search-tiktok-9999999-git-main-qredes2.vercel.app/'
        while True:
            try:
                try:
  ...
  def check_linked(self,email):
    ...
    while True:
      try:
          g=get('https://tik-tok-check-99999999999-git-main-qredes2.vercel.app/?email={}'.format(email)).json()['status']
          if g == True:
              return True
          else:
              return False
